...
public class DwdTradeOrderPreProcess {
    public static void main(String[] args) throws Exception {
        ...
        Table orderInfoTable = tableEnv.sqlQuery("" +
                ...
                "                `old`  " +
                "        from topic_db    " +
                "        where `database`='gmall' and `table`='order_info' and (`type`='insert' or `type`='update')");
        ...
        Table orderDetailActivityTable = tableEnv.sqlQuery("" +
                ...
                "            and `table` = 'order_detail_activity'  and `type`='insert'");
...
//        tableEnv.toAppendStream(orderDetailCouponTable, Row.class).print(">>>>>");
        ...
        Table resultTable = tableEnv.sqlQuery("" +
                ...
                "        left join order_detail_activity_table oa on od.id=oa.order_detail_id " +
                "        left join  order_detail_coupon_table oc on od.id=oc.order_detail_id " +
